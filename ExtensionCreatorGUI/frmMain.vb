    ...
    Private Sub Install()
        ...
        For Each ExtensionXmlFile As String In My.Settings.ExtensionXmlFiles
            If Not Path.IsPathRooted(ExtensionXmlFile) Then
                ExtensionXmlFile = My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\Extension Creator\" & ExtensionXmlFile.Substring(9)  'Use Substring to get past the ../../../ at the start of string.
            End If
